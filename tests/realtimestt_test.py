...
if __name__ == '__main__':
    ...
    parser.add_argument('-m', '--model', type=str, default='openai/whisper-large-v3-turbo',
                        help='Path to the Whisper model or model identifier. Default is openai/whisper-large-v3-turbo')
    ...
    parser.add_argument('-q', '--quick', action='store_true',
                help='Enable quick mode for faster processing with slightly reduced accuracy.')

    parser.add_argument('-d', '--device', type=str, default='auto',
                help='Device to use for inference: "cpu", "gpu", or "auto". Default is "auto".')
    ...
    if args.model is not None:
        recorder_config['model_path'] = args.model
        print(f"Argument 'model_path' set to {recorder_config['model_path']}")
    if args.lang is not None:
        recorder_config['language'] = args.lang
        print(f"Argument 'language' set to {recorder_config['language']}")
    if args.device is not None:
        recorder_config['device'] = args.device
        print(f"Argument 'device' set to {recorder_config['device']}")
    if args.quick:
        recorder_config['quick_mode'] = True
